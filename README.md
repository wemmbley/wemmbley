...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 24px; margin-top: 32px;">
  ...
  <!-- WEX.JS -->
  <div style="border: 1px solid #41b883; border-radius: 12px; padding: 20px;">
    <img src="https://upload.wikimedia.org/wikipedia/commons/f/f1/Vue.png" width="48">
    <h3>WEX.JS</h3>
    <p>Мой аналог Vue. Реактивный UI-движок.</p>
